...
The live site uses FormSubmit via an AJAX fetch request. This allows the form to work on static hosting (GitHub) without a dedicated PHP server.
...
This file contains the Server-Side PHP logic requested for my assignment, including:

Data retrieval via $_POST.

Security sanitization using htmlspecialchars().
